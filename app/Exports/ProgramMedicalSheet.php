...
class ProgramMedicalSheet implements WithTitle, WithHeadings,  ShouldAutoSize, WithMapping, FromCollection
{
    ...
    public function __construct($cutoffdate, array $array_programacion_medica)
    {
    ...
    {
        // dd($this->array_programacion_medica);
        //$$thiscont = 0;
        foreach ($this->array_programacion_medica as $key1 => $value1) {
